...
/*! Collaps & Accordion */
document.addEventListener('DOMContentLoaded',function(){document.querySelectorAll('[data-bs-toggle="collapse"]').forEach(t=>{const e=document.querySelector(t.getAttribute('data-bs-target'));if(e.classList.contains('show')){t.classList.add('show'),e.style.height=e.scrollHeight+'px'}t.addEventListener('click',function(){const s=e.classList.contains('show');if(t.closest('[data-bs-parent]')&&t.closest('[data-bs-parent]').querySelectorAll('.collapse.show').forEach(i=>{i!==e&&(i.style.height=0,i.classList.remove('show'),i.previousElementSibling.classList.remove('show'))}),s)e.style.height=0,e.classList.remove('show'),t.classList.remove('show');else{e.style.height=e.scrollHeight+'px',e.classList.add('show'),t.classList.add('show')}})}),document.querySelectorAll('.collapse').forEach(e=>{e.style.transition='height 0.35s ease'})});
